const UPDATES = [
  {
    version: '3.0.0',
    date: '22 Fev 2026',
    title: 'Algorithme V2 + Design Apple',
    changes: [
      'Algorithme propriétaire repensé : 8 facteurs d\'analyse au lieu de 6',
      'Courbes lisses pour une réactivité accrue du signal',
      'Calibration automatique améliorée avec validation croisée',
      'Transitions fluides style Apple (spring easing, glassmorphism)',
      'Animations au scroll et micro-interactions sur les boutons',
      'Compteurs animés sur les scores et indices',
    ],
  },
  {
    version: '2.8.0',
  ...
  },
  {
    ...
    changes: [
      'Scanner dédié aux paires Bitunix Perpetual Futures (210+ paires)',
      'Cartes résumé par signal (Achat Fort, Bullish, Bearish, Neutre, etc.)',
      'Signaux simplifiés et plus lisibles',
      'Design amélioré : tailles, paddings et espacements optimisés',
    ],
  },
  {
    version: '2.6.0',
    ...
    changes: [
      'Scanner complet de toutes les cryptos avec signaux propriétaires',
      'Signal global combinant plusieurs indicateurs internes',
      'Tri par signal, sentiment et variation 24h',
  ...
  },
  {
    version: '2.5.0',
    date: '15 Fev 2025',
    title: 'Indicateur dédié',
    changes: [
      'Nouvel onglet Indicateur dédié',
      'Analyse technique intégrée dans l\'algorithme propriétaire',
      'Historique du signal avec graphique interactif',
      'Décomposition du signal en temps réel',
  ...
  },
  {
    ...
    changes: [
      'Architecture repensée et modernisée',
      'Indice d\'Opportunité avec calibration automatique',
  ...
  },
  {
    ...
    changes: [
      'Sources de données optimisées pour plus de fiabilité',
