    ...
    <div className="animate-fadeInUp">
      ...
      <section className="max-w-4xl mx-auto text-center py-24 px-4">
        ...
        <p className="text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed mb-4">
          Gagnez du temps sur votre analyse. Cet outil vous aide a lire les phases de marche complexes en un coup d'oeil — que vous soyez en trading ou en spot, debutant ou confirme.
        </p>
        <p className="text-sm text-zinc-600 mb-10 max-w-xl mx-auto">
          Pas de signaux de trading. Pas d'indicateur magique. Juste un outil pour faciliter vos propres decisions.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
          ...
          >
            {isLoggedIn ? 'Acceder au Dashboard' : 'Essayer 7 jours gratuitement'}
          </button>
          <button
            onClick={onPricing}
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-base text-zinc-500 max-w-xl mx-auto">Un outil pour tous les niveaux. Que vous fassiez du spot ou du perpetual, debutant ou confirme, simplifiez votre lecture de marche.</p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Visualisez en un clin d\'oeil la phase de chaque crypto sur 210+ paires Bitunix. Fini les heures a analyser chart par chart — tout est regroupe ici.',
            },
            {
              icon: (
                <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
              ),
              title: 'Lecture de marche simplifiee',
              desc: 'Notre outil synthetise les conditions de marche en un score clair. Vous n\'avez plus besoin de croiser 10 sources differentes — concentrez-vous sur vos decisions.',
            },
            {
              icon: (
              ...
              desc: 'Recevez une notification quand une crypto change de phase de marche. Vous restez informe sans rester colle a l\'ecran. Navigateur + Telegram.',
            },
          ].map((f, i) => (
            <div
              key={i}
      ...
      <section className="max-w-5xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-base text-zinc-500">Un outil, pas une promesse. Vous gardez le controle de vos decisions.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { step: '01', title: 'Essayez gratuitement', desc: '7 jours d\'acces complet, sans engagement. Creez votre compte en 30 secondes et explorez tous les outils.' },
            { step: '02', title: 'Comprenez les phases', desc: 'Le Radar affiche la phase de chaque crypto en temps reel. Accumulation, tendance, surachat — tout est lisible instantanement, meme pour un debutant.' },
            { step: '03', title: 'Prenez vos decisions', desc: 'Spot ou trading, c\'est vous qui decidez. L\'outil vous fait gagner du temps d\'analyse, il ne decide jamais a votre place.' },
          ].map((s, i) => (
      ...
      <section className="max-w-5xl mx-auto px-4 py-20">
        <div className="rounded-3xl border border-white/[0.06] p-12" style={{ background: 'linear-gradient(135deg, rgba(11,11,20,0.95) 0%, rgba(22,22,42,0.95) 100%)' }}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: '210+', label: 'Paires analysees', color: '#60a5fa' },
              { value: '24/7', label: 'Surveillance live', color: '#34d399' },
              { value: '2min', label: 'Rafraichissement', color: '#fbbf24' },
              { value: '100%', label: 'Vous decidez', color: '#c084fc' },
            ].map((s, i) => (
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="rounded-3xl border border-white/[0.06] p-10" style={{ background: 'linear-gradient(135deg, rgba(11,11,20,0.95) 0%, rgba(22,22,42,0.95) 100%)' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              { text: 'Pas un service de signaux de trading', detail: 'Nous ne vous disons jamais quand acheter ou vendre. C\'est votre decision.' },
              { text: 'Pas un indicateur magique', detail: 'Aucun outil ne predit le marche. Le notre vous aide simplement a le lire plus vite.' },
              { text: 'Pas reserve aux experts', detail: 'L\'interface est pensee pour etre lisible par tous, debutants comme confirmes.' },
      ...
      <section className="max-w-3xl mx-auto text-center px-4 py-24">
        <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
          Simplifiez votre analyse. Gardez le controle.
        </h2>
        <p className="text-base text-zinc-500 mb-4 max-w-lg mx-auto">
          Un outil pour tous les niveaux qui vous fait gagner du temps, en spot comme en trading. Testez par vous-meme.
        </p>
        <p className="text-sm text-zinc-600 mb-10">7 jours gratuits, sans engagement. Vous decidez ensuite.</p>
